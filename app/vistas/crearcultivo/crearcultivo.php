        ...
        <div class="contorno">
            <div class="contenedorFincacultivos">
                <div class="cultivos">
                    ...
                    <div class="datosCultivo" ng-show="crearcultivofinca==='1'">
                        <div class="titulocultivos">
                            <h1 class="nombrefinca">Registro de Cultivo</h1>
                        </div>
                        <div class="cultivos4">
                            <div class="inputCultivo">
                                <form action="<?php echo RUTA_URL . 'florian/agregarCultivo' ?>" method="POST">
                                    <center>
                                        <p class="label">Tipo de Cultivo</p>
                                    </center>
                                    <center><input class="ingresarDatocultivo" placeholder="Tipo de Cultivo" name="tipo" required=""></center>
                                    <center>
                                        <p class="label">Áres M2</p>
                                    </center>
                                    <center><input class="ingresarDatocultivo" placeholder="Área en m2" name="area" required=""></center>
                                    <center>
                                        <p class="label">Descripción</p>
                                    </center>
                                    <center><textarea class="ingresarDatocultivoD" placeholder="Descripción" name="descripcion" required=""></textarea></center>
                                    <p> <?php
                                        if (!empty($datos['error'])) {
                                            echo $datos['error'];
                                        }
                                        ?> </p>
                                    <center><input type="submit" class="volvercultivo" value="Aceptar"><br>
