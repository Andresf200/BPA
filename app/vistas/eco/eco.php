...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo RUTA_URL . 'public/css/guiasEco.css' ?>">
        ...
        <div class="contorno">
            <div class="contenedorGuias">
                <div class="guias">
                    ...
                    <div class="guias2">
                        <div class="contornoeco" ng-show="ecos1 === '1">
                            <div class="ecoTitulo">
                                <center>
                                    <h1 class="tituloEco">Eco</h1>
                                </center>
                            </div>
                            <div class="ecoInfo">
                                <div class="ecoInfotext">
                                    <?php
