...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo RUTA_URL . 'public/css/guiasDocumentos.css' ?>">
        ...
        <div class="contorno">
            <div class="contenedorGuias">
                <div class="guias">
                    ...
                    <div class="guias2">
                        <div class="contornodocu">
                            <div class="docuTitulo">
                                <center>
                                    <h1 class="tituloDocu">Documentacion</h1>
                                </center>
                            </div>
                            <div class="docuInfo">
                                <div class="docuInfotext">
                                    <?php
